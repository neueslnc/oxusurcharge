    ...
    <div class="page-content">
        ...
        <div class="card radius-10">
                 <div class="card-body">
                    ...
                    <div class="row">
                        <a class="btn btn-success col-md-12" href="{{ route('superadmin.statement_get_static')  }}">
                            EXPORT XLSX
                        </a>
                    </div>
                    <br>
...
<script>
    ...
    function filter_group() {
        ...
        $.ajax('{{ route('superadmin.statement_month_filter') }}', {
            type : "GET",
            data : {
            ...
            success : function (data, status){
                ...
                for (const iterator of data.messages) {
                    ...
                    <tr>
                        ...
                        <td>
                            ${create.getDay() <10 ? '0'+create.getDay():create.getDay()}-${create.getMonth() <10 ? '0'+create.getMonth():create.getMonth()}-${create.getFullYear()}
                        </td>
                        <td>
                            ${ iterator.location }
                        </td>
                        <td>
                            ${data.getDay() <10 ? '0'+data.getDay():data.getDay()}-${data.getMonth() <10 ? '0'+data.getMonth():data.getMonth()}-${data.getFullYear()}
                        </td>
                        <td>
                            ${ iterator.time }
                        </td>
                        ...
                        <td>
                            <div class="row">
                                    <form class="col-md-4">
                                                        <a class="btn btn-primary btn-sm" href="statement/${iterator.id}" target="_blank"><i class="bx bx-trash mr-1"></i>Просмотр</a>
                                                    </form>
                                </div>
                        </td>
                    </tr>
    ...
    $('#month_filter').change( function () {
        ...
        a.href = `{{ route('superadmin.statement_get_static') }}?month=${$("#month_filter option:selected").val()}`;
