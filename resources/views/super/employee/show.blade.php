                                ...
                                <table class="table table-bordered align-middle mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="fixed_header2 align-middle">Umumiy soni</th>
                                            <th class="fixed_header2 align-middle">Qabul qilingan</th>
                                            <th class="fixed_header2 align-middle">Rad etilgan</th>
                                            <th class="fixed_header2 align-middle">Bajaril- magan</th>
                                ...
                                <table class="table table-bordered align-middle mb-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4 class="text-success">
                                                        {{ $user->articles_accept_count }}
                                                    </h4>
                                                </td>
                                                <td>
                                                    <h4 class="text-danger">
                                                        {{ $user->articles_reject_count }}
                                                    </h4>
                                                </td>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        <div class="d-flex flex-column align-items-center text-center alert alert-primary" role="alert">
                                     Sizga yuborilgan xabarlar!
                                          </div>
                                    </div>
                                    <div class="row">
                                        @foreach ($notifications as $notification)
                                        @php
                                            $message=str_replace('<p>','',$notification->message);
                                        ...
                                        <form action="{{ route('profiles.store') }}" method="POST">
                                            ...
                                            <input style="width: 100px;height:50px" class="btn btn-info" type="submit" value="Ko'rildi!">
                                        </form>
                                        </div>
                                        @endforeach
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="progress mb-3" style="height: 5px">
                                            <div class="progress-bar bg-success" role="progressbar" style="width: {{ ($user->get_percent_teacher()/55)*100 }}%" aria-valuenow="{{ $user->get_percent_teacher() }}" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
