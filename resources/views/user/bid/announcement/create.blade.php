            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">E'lon yangi</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="post" action="{{ route('user.announcement.store') }}">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="time" class="form-label">Soat</label>
