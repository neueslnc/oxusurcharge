            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="post" action="{{ route('emloyees.update',['emloyee'=>$user->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select mb-3" name="departament_id" aria-label="Default select example">
                                    @foreach ($departaments as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($user->departament_id==$item->id)
                                            selected  
                                          @endif
                                          >{{ __($item->name) }}
                                    </option>
                            ...
                            <div class="col-md-12">
                                <label for="number_phone" class="form-label">Telefon raqam</label>
                                <input type="number_phone" name="number_phone" class="form-control" id="number_phone" value="{{ $user->number_phone != null ? $user->number_phone : "998" }}">
                            </div>
